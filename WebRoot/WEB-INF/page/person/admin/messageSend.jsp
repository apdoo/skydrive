                        ...
                        <form id="id-message-form" class="form-horizontal message-form  col-xs-12">
                            <div class="">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="userName">用户名(多个用户之间用,区分):</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="messageTitle">标题:</label>
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="input-icon block col-xs-12 no-padding">
                                            <input maxlength="100" type="text" class="col-xs-12" name="messageTitle" id="messageTitle" placeholder="标题">
...
<!-- inline scripts related to this page -->
  <script type="text/javascript">
     ...
     function submita(){
         ...
         $.ajax({
             type : "POST",
             url : "${pageContext.request.contextPath}/message/sendMessage",
             dataType:"json",
             data :{
                 userName:userName,
