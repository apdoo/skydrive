...
<div class="alert alert-block alert-success">
 ...
 <div class="row">
    ...
    <p id="check_tips" align="center">
        <button class="btn" onclick="download()">下载地址 </button>
        <button class="btn btn-primary" onclick="recover()">放入回收站</button>
...
<script type="text/javascript">
    ...
    function initTable(){
        ...
        jQuery(grid_selector).jqGrid({
            datatype: 'json',
            url: '${pageContext.request.contextPath}/user/uploadLogs?flag=0',//flag=0的为公开的正常状态的文件
            mtype: 'post',//请求方式
            height: 250,
...
//            rowList:[10,20,30],
    ...
    function download(){
        ...
        if(selectedIds!=""){
            $.ajax({
                type : "POST",
                url : "${pageContext.request.contextPath}/file/downloadUrl",
                dataType:"json",
                data : {
                    ids : selectedIds
                },
    ...
    function recover(){
        ...
        if(selectedIds!=""){
            $.ajax({
                type : "POST",
                url : "${pageContext.request.contextPath}/file/recover",
                dataType:"json",
                data : {
                    ids : selectedIds
                },
